...
|------|----------|----------|----------|------|
| condemn | 已完成 | 掌握 | 3 | 6模块学习完成 |
| condition* | 已完成 | 掌握 | 3 | 6模块学习完成 |
| conduct | 已完成 | 掌握 | 3 | 6模块学习完成 |
| conductor | 已完成 | 掌握 | 3 | 6模块学习完成 |
| conference | 已完成 | 掌握 | 3 | 6模块学习完成 |
| confidence* | 已完成 | 掌握 | 3 | 6模块学习完成 |
| confident* | 已完成 | 掌握 | 3 | 6模块学习完成 |
| confine | 已完成 | 掌握 | 3 | 6模块学习完成 |
| confirm | 已完成 | 掌握 | 3 | 6模块学习完成 |
| conflict | 已完成 | 掌握 | 3 | 6模块学习完成 |
| confront | 已完成 | 掌握 | 3 | 6模块学习完成 |
| confuse* | 已完成 | 掌握 | 3 | 6模块学习完成 |
| confusing* | 已完成 | 掌握 | 3 | 6模块学习完成 |
| congratulate | 已完成 | 掌握 | 3 | 6模块学习完成 |
| congress | 已完成 | 掌握 | 3 | 6模块学习完成 |
| connect | 已完成 | 掌握 | 3 | 6模块学习完成 |
| connection | 已完成 | 掌握 | 3 | 6模块学习完成 |
| conquer | 已完成 | 掌握 | 3 | 6模块学习完成 |
| conscious | 已完成 | 掌握 | 3 | 6模块学习完成 |
| consequence | 已完成 | 掌握 | 3 | 6模块学习完成 |
