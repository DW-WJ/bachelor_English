...
## 单词17：concert* [ˈkɑːnsərt] n. 音乐会，演奏会
...
- **必记搭配**：
  ...
  - 📌 in conclusion：总之
  - 📌 reach conclusion：达成结论

**考试陷阱预警**：
- ⚠️ 注意与ending的区别：conclusion强调"结论"，ending强调"结尾"
- **上下文判断技巧**：当句子涉及结果、总结时，考虑conclusion

### 模块3：记忆强化

**轻量化记忆技巧**：
- **场景串联记忆**：想象在讨论时，有人说"We draw conclusions."（我们得出结论。）
- **词根联想记忆**：conclusion（结论）= conclude（结束）+ ion（名词后缀）
- **关联已知词**：与ending（结尾）一起记忆

**易混词对比**：

| 词汇 | 音标 | 核心区别（考试易考点） | 真题级例句 |
|------|------|-------------------------|------------|
| conclusion | [kənˈkluːʒn] | 强调"结论"，结论名词 | We draw conclusions. |
| ending | [ˈendɪŋ] | 强调"结尾"，结尾名词 | We draw endings. |

**近义词/反义词**（词汇表内）：
- 近义词：ending（结尾）、result（结果）
- 反义词：beginning（开始）、introduction（介绍）
...
| 例句内容 | 词汇拆分 | 语法标记 | 翻译 | 语法提示 |
|---------|---------|---------|------|----------|
| We draw conclusions. | We [wiː] pron. 我们；draw [drɔː] v. 得出；conclusions [kənˈkluːʒnz] n. 结论（复数） | 一般现在时，复数 | 我们得出结论。 | conclusions作宾语 |
| The conclusion is valid. | The [ðə] art. 定冠词；conclusion [kənˈkluːʒn] n. 结论；is [ɪz] v. 是；valid [ˈvælɪd] adj. 有效的 | 主系表结构，一般现在时 | 结论是有效的。 | conclusion作主语 |

**题型适配技巧**：
- **针对阅读**：conclusion常出现在描述研究、分析的文章中
- **针对完形**：注意conclusion的名词用法，特别是draw conclusion
- **针对写作**：提供安全实用的写作句型："We must support our conclusions."（我们必须支持我们的结论。）
...
1. **选词填空**：
   We draw ____.
   A. conclusions  B. endings  C. both A and B
   答案：A
   解析：conclusion表示"结论"，ending表示"结尾"，但conclusion更常用

2. **语法判断**：
   句子"The conclusion is valid."是否正确？
   答案：正确
   解析：conclusion作主语，句子正确

**艾宾浩斯复习提示**：
- **第1次复习**：学完当天睡前（5分钟）
  - 重点看：conclusion的用法 + 自测错题
- **第2次复习**：第2天早上（3分钟）
  - 快速过：核心含义 + 易混词对比
- **第3次复习**：第7天（5分钟）
  - 重做自测题，检查是否真正掌握
...
1. **用户问**："conclusion重点考什么？"
   **响应**：conclusion在学位英语考试中偶尔出现（阅读理解占比20%）。核心考点：draw conclusion（得出结论）、in conclusion（总之）、reach conclusion（达成结论）。注意与ending的区别。

2. **用户问**："怎么记conclusion这个词？"
   **响应**：推荐词根联想记忆法：conclusion（结论）= conclude（结束）+ ion（名词后缀）。另外，可以与ending一起记忆。

---

## 单词20：concrete [ˈkɑːŋkriːt] n. 混凝土
...
**词根词缀拆解**：
- concrete = con (一起) + crete (生长)
- 构词逻辑：一起生长，即"混凝土"
- 同根词：concrete (n. 混凝土), concretely (adv. 具体地)

**核心信息标准化输出**：
- 音标：英 [ˈkɑːŋkriːt] 美 [ˈkɑːŋkriːt]
- 词性：n. (名词)
- 核心含义：
  - ★★☆☆☆ n. 混凝土
- 词源：源自con + crete，意为"混凝土"

### 模块2：考点聚焦

**高频考点标注**：
- **考试常考义项**：
  - ★★☆☆☆ n. 混凝土：在阅读理解和完形填空中偶尔出现
- **高频题型关联**：
  - 阅读理解占比20%（描述建筑相关话题）
  - 完形填空占比10%（名词选择）
  - 写作占比10%（表达建筑）
...
**考试陷阱预警**：
- ⚠️ 注意与cement的区别：concrete强调"混凝土"，cement强调"水泥"
- **上下文判断技巧**：当句子涉及建筑、材料时，考虑concrete

### 模块3：记忆强化

**轻量化记忆技巧**：
- **场景串联记忆**：想象在讨论时，有人说"We use concrete."（我们使用混凝土。）
- **词根联想记忆**：concrete（混凝土）= con（一起）+ crete（生长）
- **关联已知词**：与cement（水泥）一起记忆

**易混词对比**：

| 词汇 | 音标 | 核心区别（考试易考点） | 真题级例句 |
|------|------|-------------------------|------------|
| concrete | [ˈkɑːŋkriːt] | 强调"混凝土"，混凝土名词 | We use concrete. |
| cement | [sɪˈment] | 强调"水泥"，水泥名词 | We use cement. |

**近义词/反义词**（词汇表内）：
- 近义词：cement（水泥）、material（材料）
...
| 例句内容 | 词汇拆分 | 语法标记 | 翻译 | 语法提示 |
|---------|---------|---------|------|----------|
| We use concrete. | We [wiː] pron. 我们；use [juːz] v. 使用；concrete [ˈkɑːŋkriːt] n. 混凝土 | 一般现在时，复数 | 我们使用混凝土。 | concrete作宾语 |
| The concrete is strong. | The [ðə] art. 定冠词；concrete [ˈkɑːŋkriːt] n. 混凝土；is [ɪz] v. 是；strong [strɔːŋ] adj. 坚固的 | 主系表结构，一般现在时 | 混凝土很坚固。 | concrete作主语 |

**题型适配技巧**：
- **针对阅读**：concrete常出现在描述建筑、工程的文章中
- **针对完形**：注意concrete的名词用法，特别是concrete structure
- **针对写作**：提供安全实用的写作句型："We must choose quality concrete."（我们必须选择优质混凝土。）
...
1. **选词填空**：
   We use ____.
   A. concrete  B. cement  C. both A and B
   答案：A
   解析：concrete表示"混凝土"，cement表示"水泥"，但concrete更常用

2. **语法判断**：
   句子"The concrete is strong."是否正确？
   答案：正确
   解析：concrete作主语，句子正确

**艾宾浩斯复习提示**：
- **第1次复习**：学完当天睡前（5分钟）
  - 重点看：concrete的用法 + 自测错题
- **第2次复习**：第2天早上（3分钟）
  - 快速过：核心含义 + 易混词对比
- **第3次复习**：第7天（5分钟）
  - 重做自测题，检查是否真正掌握
...
1. **用户问**："concrete重点考什么？"
   **响应**：concrete在学位英语考试中偶尔出现（阅读理解占比20%）。核心考点：concrete structure（混凝土结构）、reinforced concrete（钢筋混凝土）、concrete block（混凝土块）。注意与cement的区别。

2. **用户问**："怎么记concrete这个词？"
   **响应**：推荐词根联想记忆法：concrete（混凝土）= con（一起）+ crete（生长）。另外，可以与cement一起记忆。
...
|------|----------|----------|----------|--------------|
| component | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| compose | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| composer | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| composition | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| compound | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| comprehension | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| comprehensive | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| compromise | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| computer* | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| comrade | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| conceal | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| concentrate | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| concentration | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| concept | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| concern* | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| concerning* | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| concert* | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| conclude | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| conclusion | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
| concrete | ✅ 已完成 | ⭐⭐⭐ | 0 | 2024-01-XX |
